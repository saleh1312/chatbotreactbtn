...
export function RepliedButton(props) {
  ...
  if(ele.sent_by_customer===true){
      return(
        <div className="w-100 d-flex flex-row-reverse mt-2 pr-2" key={i}>
          <div className="p-2 d-flex flex-row justify-content-center align-items-center" style={{maxWidth:"80%",minWidth:"20%" , borderTopLeftRadius:"20px" , borderTopRightRadius:"20px" ,  borderBottomLeftRadius:"20px" }}>
